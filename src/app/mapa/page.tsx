  ...
  return (
    <div className="min-h-screen bg-[#111827] text-white flex flex-col overflow-hidden">
      <header className="h-16 shrink-0 bg-[#1b2333] border-b border-white/10 px-5 flex items-center justify-between shadow-lg">
        <div className="flex items-center gap-3"><div className="w-9 h-9 rounded-xl bg-[#f26b5b] flex items-center justify-center font-black">MC</div><div><p className="font-bold tracking-tight">Missão Construtores</p><p className="text-[11px] text-white/45">Escritório virtual · Colégio 21 de Maio</p></div></div>
